...
<section className="text-gray-400 bg-gray-900 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <p className="leading-relaxed text-lg">"Knowledge becomes power only when we put it into some use".....so let's honour our knowledge by answering some simple GK questions......... "Knowledge has a beginning but no end".......so let's keep ourselves going.</p>
